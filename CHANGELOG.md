...
## [1.0.0-rc.1]
### Uncategorized
- chore(deps): bump `word-wrap` and `semver` ([#140](https://github.com/MetaMask/eth-snap-keyring/pull/140))
- chore(deps): bump @metamask/scure-bip39 from 2.1.0 to 2.1.1 ([#133](https://github.com/MetaMask/eth-snap-keyring/pull/133))
- chore(deps): bump postcss from 8.4.20 to 8.4.31 ([#137](https://github.com/MetaMask/eth-snap-keyring/pull/137))
- chore: bump `@metamask` dependencies ([#139](https://github.com/MetaMask/eth-snap-keyring/pull/139))
- feat: add `getAccountByAddress` method ([#134](https://github.com/MetaMask/eth-snap-keyring/pull/134))
...
[Unreleased]: https://github.com/MetaMask/eth-snap-keyring/compare/v1.0.0-rc.1...HEAD
