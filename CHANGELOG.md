...
## [4.2.1]
### Uncategorized
- fix: 4337 methods from keyring-api 6.2.1 ([#312](https://github.com/MetaMask/eth-snap-keyring/pull/312))
- chore(deps): bump @metamask/post-message-stream from 8.0.0 to 8.1.0 ([#297](https://github.com/MetaMask/eth-snap-keyring/pull/297))
- chore(deps): bump @metamask/permission-controller from 9.0.2 to 9.1.0 ([#306](https://github.com/MetaMask/eth-snap-keyring/pull/306))
- chore(deps): bump @metamask/snaps-sdk from 4.2.0 to 4.3.0 ([#308](https://github.com/MetaMask/eth-snap-keyring/pull/308))
