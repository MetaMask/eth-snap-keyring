...
## [0.3.1]
### Uncategorized
- chore: use `--prettier` option of auto-changelog ([#128](https://github.com/MetaMask/eth-snap-keyring/pull/128))
- chore(deps): bump @metamask/snaps-utils from 2.0.0 to 2.0.1 ([#126](https://github.com/MetaMask/eth-snap-keyring/pull/126))
- chore(deps): bump @metamask/snaps-controllers from 2.0.0 to 2.0.1 ([#124](https://github.com/MetaMask/eth-snap-keyring/pull/124))
- chore(deps-dev): bump @metamask/auto-changelog from 3.2.0 to 3.3.0 ([#127](https://github.com/MetaMask/eth-snap-keyring/pull/127))
- chore: revert change for consistency ([#123](https://github.com/MetaMask/eth-snap-keyring/pull/123))
- feat: add the `getAccountsBySnapId` method ([#122](https://github.com/MetaMask/eth-snap-keyring/pull/122))
- fix: remove the `removeAccountsBySnapId` method ([#121](https://github.com/MetaMask/eth-snap-keyring/pull/121))
- fix: call external function with lowercase address ([#120](https://github.com/MetaMask/eth-snap-keyring/pull/120))
