...
## [4.1.1]
### Uncategorized
- chore(deps): bump snap and keyring-api ([#294](https://github.com/MetaMask/eth-snap-keyring/pull/294))
- chore(deps): bump @metamask/key-tree from 9.0.0 to 9.1.0 ([#293](https://github.com/MetaMask/eth-snap-keyring/pull/293))
...
[Unreleased]: https://github.com/MetaMask/eth-snap-keyring/compare/v4.1.1...HEAD
