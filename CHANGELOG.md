...
## [3.0.0]
### Uncategorized
- chore(deps): bump @metamask/utils from 8.3.0 to 8.4.0 ([#260](https://github.com/MetaMask/eth-snap-keyring/pull/260))
- chore(deps): bump @metamask/keyring-api from 5.0.0 to 5.1.0 ([#259](https://github.com/MetaMask/eth-snap-keyring/pull/259))
- feat!: add KeyringExecutionContext to user ops methods ([#253](https://github.com/MetaMask/eth-snap-keyring/pull/253))
- chore(deps): bump @metamask/utils from 8.3.0 to 8.4.0 ([#256](https://github.com/MetaMask/eth-snap-keyring/pull/256))
- chore(deps): bump @metamask/keyring-api from 4.0.2 to 5.0.0 ([#255](https://github.com/MetaMask/eth-snap-keyring/pull/255))
- feat: add logger + now log Snap requests ([#254](https://github.com/MetaMask/eth-snap-keyring/pull/254))
