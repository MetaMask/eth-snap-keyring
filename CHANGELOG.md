...
## [4.3.2]
### Uncategorized
- Bump `@metamask/snaps-{sdk,utils,controllers}` ([#363](https://github.com/MetaMask/eth-snap-keyring/pull/363))
- chore(deps): bump @metamask/snaps-sdk from 6.0.0 to 6.1.0 ([#359](https://github.com/MetaMask/eth-snap-keyring/pull/359))
- chore(deps): bump @metamask/permission-controller from 10.0.0 to 10.0.1 ([#358](https://github.com/MetaMask/eth-snap-keyring/pull/358))
- chore(deps): bump braces from 3.0.2 to 3.0.3 in the npm_and_yarn group across 1 directory ([#332](https://github.com/MetaMask/eth-snap-keyring/pull/332))
- chore(deps): bump @metamask/controller-utils from 11.0.0 to 11.0.1 ([#360](https://github.com/MetaMask/eth-snap-keyring/pull/360))
- chore(deps): bump @metamask/snaps-utils from 7.7.0 to 7.8.0 ([#361](https://github.com/MetaMask/eth-snap-keyring/pull/361))
- chore(deps): bump @metamask/base-controller from 6.0.0 to 6.0.1 ([#362](https://github.com/MetaMask/eth-snap-keyring/pull/362))
- chore(deps): bump @metamask/post-message-stream from 8.1.0 to 8.1.1 ([#355](https://github.com/MetaMask/eth-snap-keyring/pull/355))
- chore(deps): replace `superstruct` imports with `@metamask/superstruct` ([#311](https://github.com/MetaMask/eth-snap-keyring/pull/311))
- chore(deps): bump @metamask/eth-sig-util from 7.0.2 to 7.0.3 ([#353](https://github.com/MetaMask/eth-snap-keyring/pull/353))
- chore(deps): bump @metamask/providers from 17.1.0 to 17.1.1 ([#352](https://github.com/MetaMask/eth-snap-keyring/pull/352))
- chore(deps): bump @metamask/abi-utils from 2.0.3 to 2.0.4 ([#350](https://github.com/MetaMask/eth-snap-keyring/pull/350))
- chore(deps): bump @metamask/key-tree from 9.1.1 to 9.1.2 ([#349](https://github.com/MetaMask/eth-snap-keyring/pull/349))
- chore(deps): bump @metamask/snaps-registry from 3.2.0 to 3.2.1 ([#351](https://github.com/MetaMask/eth-snap-keyring/pull/351))
- chore(deps): bump @metamask/snaps-rpc-methods from 9.1.2 to 9.1.4 ([#340](https://github.com/MetaMask/eth-snap-keyring/pull/340))
- chore(deps): bump @metamask/snaps-utils from 7.5.0 to 7.7.0 ([#341](https://github.com/MetaMask/eth-snap-keyring/pull/341))
- chore(deps): bump @metamask/snaps-registry from 3.1.0 to 3.2.0 ([#343](https://github.com/MetaMask/eth-snap-keyring/pull/343))
- chore(deps): bump @metamask/abi-utils from 2.0.2 to 2.0.3 ([#345](https://github.com/MetaMask/eth-snap-keyring/pull/345))
- chore(deps): bump @metamask/rpc-errors from 6.3.0 to 6.3.1 ([#348](https://github.com/MetaMask/eth-snap-keyring/pull/348))
- chore(deps): bump @metamask/providers from 17.0.0 to 17.1.0 ([#346](https://github.com/MetaMask/eth-snap-keyring/pull/346))
